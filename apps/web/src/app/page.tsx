					...
					<div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
						<Card className="transition-all hover:shadow-lg hover:-translate-y-1">
							<CardHeader>
								...
								<CardDescription>
									Análisis profundo de tus estados financieros con visualizaciones
									interactivas y métricas clave de rendimiento
								</CardDescription>
							</CardHeader>
						</Card>
							...
							<div className="space-y-4">
								...
								<div className="flex gap-4">
									...
									<div>
										...
										<p className="text-muted-foreground">
											Accede a información actualizada al instante con dashboards
											interactivos y alertas personalizadas
										</p>
									</div>
								</div>
			...
			<footer className="px-4 py-12 border-t bg-muted/30">
				<div className="container mx-auto max-w-6xl">
					...
					<div className="mt-12 pt-8 border-t text-center text-sm text-muted-foreground">
						<p>
							© 2024 Consultoría Financiera. Todos los derechos reservados.
						</p>
					</div>
				</div>
			</footer>
